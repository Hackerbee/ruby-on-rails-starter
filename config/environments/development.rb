...
http_url_options        = { host: "localhost", port: 3000 }
...
Rails.application.configure do
  ...
  if Rails.root.join("tmp/caching-dev.txt").exist?
    config.action_controller.default_url_options           = http_url_options
  ...
  # activerecord-enhancedsqlite3-adapter configuration. does not work well with multi-db setup with >2 DBs.
  config.enhanced_sqlite3.isolate_connection_pools = false
end
